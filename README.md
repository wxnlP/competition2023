...
![1708175264070](pic/1708175264070.png)
...
![1708177074464](pic/1708177074464.png)

**比赛场地：**

![1708177434452](pic/1708177434452.png)
...
![img](pic/9a504fc2d56285354e2f2a2f9fef76c6a6ef63f5.jpg)

![img](pic/1f178a82b9014a90f4558b25a3773912b31bee3b.jpg)

电机选择，直流减速电机和步进电机，推荐**直流减速电机**即可，配合PID算法做闭环控制。选择减速电机要注意一个参数：**减速比**，30即可不要太低和太高。

![1708179037254](pic/1708179037254.png)
...
![1708179801996](pic/1708179801996.png)

![1708179849308](pic/1708179849308.png)
...
![1708180164128](pic/1708180164128.png)

2.四自由度

![1708180530493](pic/1708180530493.png)
...
![1708181153870](pic/1708181153870.png)
...
![1708180921426](pic/1708180921426.png)

> **硬件方案都是其次的，重要的是定位算法和机械臂路径规划的准确性。**

#### 3.1.3 注意事项

![1708181319625](pic/1708181319625.png)

![1708181378802](pic/1708181378802.png)

![1708181443508](pic/1708181443508.png)
...
![1708238068702](pic/1708238068702.png)
...
![1708242805223](pic/1708242805223.png)

**铝材连接键**：建议使用这种直角角码；我们也用过一些内置的连接件并不好用，当时考虑装亚克力板好装但恰恰相反，所以不推荐，直角角码相对安装更简单。

![1708242924344](pic/1708242924344.png)

![1708243045701](pic/1708243045701.png)

前面提到运输过程中螺丝容易掉，所以在铝材底部用直角铁固定，防止结构变型。

![1708243175301](pic/1708243175301.png)
...
![1708243391533](pic/1708243391533.png)
...
![1708260715405](pic/1708260715405.png)
...
![1708244316987](pic/1708244316987.png)
...
![1708249530582](pic/1708249530582.png)
...
![1708250207978](pic/1708250207978.png)
...
![1708250513291](pic/1708250513291.png)

##### 满载检测

选用超声波，根据测距判断是否满载。因为垃圾桶规定为透明，红外测距会受到影响，超声波则不会受到影响。

![1708261211492](pic/1708261211492.png)
...
![1708330842223](pic/1708330842223.png)
...
![1708343507323](pic/1708343507323.png)

解释一下**文件夹下打开终端**，例如：在**yolov5-lite文件夹**下打开终端，即终端位置在**yolov5-lite文件夹**位置。

![1708343830872](pic/1708343830872.png)

操作方法为默认终端输入`cd + your_path`，例如：

![1708343950823](pic/1708343950823.png)
...
![1708332404336](pic/1708332404336.png)

![1708329910522](pic/1708329910522.png)
...
![1708331536097](pic/1708331536097.png)

将**v5lite-s.pt**文件转移到树莓派下**yolov5-lite文件夹**下

![1708332518118](pic/1708332518118.png)

4. **摄像头配置**

检测树莓派是否有**opencv**，打开终端，输入`python3`调出python终端，输入`import cv2`不报错即可

![1708330217813](./pic/1708330217813.png)
...
![1708344562343](pic/1708344562343.png)
...
![1708344698894](pic/1708344698894.png)

Ctrl+c退出，输入`ls /dev/video*`查看摄像头设备，一般是0/1

![1708334429106](pic/1708334429106.png)
...
![1708333928679](pic/1708333928679.png)
...
![1708345128636](pic/1708345128636.png)
...
![1708946094611](pic/1708946094611.png)
...
![1708503608585](pic/1708503608585.png)
...
![1708947182342](pic/1708947182342.png)
...
![1708949657516](pic/1708949657516.png)
...
![1708952756713](pic/1708952756713.png)
...
![1715655628050](pic/1715655628050.png)
